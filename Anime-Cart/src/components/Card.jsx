...
const Card = ({ data }) => {
  ...
  return (
    <div className="w-64 bg-zinc-100 p-4 rounded-md flex gap-6 pb-8 relative mt-10">
      ...
      <button className={`${added === false ? "bg-orange-600" : "bg-teal-600"} text-white text-xs font-semibold px-4 py-3 rounded-full hover:bg-orange-700 whitespace-nowrap absolute bottom-0 left-1/2 translate-y-[50%] -translate-x-[50%]`}>
        {
